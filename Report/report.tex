...
\section{Conclusion}
Machine Learning methods coupled with feature engineering have given great results as more of 83\% of the entries have been well categorized. In particular \textit{ridge regression} was well suited for this set of data, and the better improvement in the categorization process was observed when the data was fitted with polynomials.
